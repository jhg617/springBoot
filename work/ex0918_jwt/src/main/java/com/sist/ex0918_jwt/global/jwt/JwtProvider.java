package com.sist.ex0918_jwt.global.jwt;
...
public class JwtProvider {
    ...
    public SecretKey getSecretKey(){
        if(secretKey == null){
            ...
            //application-secure.yml에 있는 secretKey의 값을 암호화
            String encoding =
    ...
    public String genToken(Map<String, Object> map, int seconds){
        ...
        String jwt = jwtBuilder.signWith(getSecretKey()).compact(); //SecretKey는 문자열로 넘어온다. compact(): 토큰을 만든다.
        return jwt;
    }
